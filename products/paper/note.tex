...
We also include a second simulation for an 8-sided dice, where the average sum of the two throws is equal to \input{../../analysis/output/estimation/500_8/mean_sum.txt}\unskip. The corresponding histogram is depicted in Figure \ref{fig:hist_500_8} 
\begin{figure}[tbh!]
\centering
\includegraphics[width=.8\linewidth]{500_8/hist.png}
\caption[]{Numerical frequency for the sum of two eight-sided die. Figure based on \input{../../analysis/output/estimation/500_8/sample_size.txt}throws.}
