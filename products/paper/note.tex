...
\begin{figure}[tbh!]
\centering
\includegraphics[width=.8\linewidth]{plot/baseline/lln_plot.png}
...
\begin{figure}[tbh!]
\centering
\includegraphics[width=.8\linewidth]{plot/500_8/lln_plot.png}
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \includegraphics[width=0.8\linewidth]{plot/baseline/lln_plot.png}  
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include second image
  \includegraphics[width=0.8\linewidth]{plot/500_8/lln_plot.png}  
