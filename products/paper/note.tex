...
\caption[]{Mean for the sum of two six-sided die. Figure based on \input{../../analysis/output/simulation/baseline/sample_size.txt}throws. Approaches value of \input{../../analysis/output/simulation/baseline/mean_sum.txt}with a median of \input{../../analysis/output/simulation/baseline/median_sum.txt}.}
...
\caption[]{Mean for the sum of two eight-sided die. Figure based on \input{../../analysis/output/simulation/500_8/sample_size.txt}throws. Approaches value of \input{../../analysis/output/simulation/500_8/mean_sum.txt}with a median of \input{../../analysis/output/simulation/500_8/median_sum.txt}.}
